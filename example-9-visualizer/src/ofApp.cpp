...
void ofApp::setup(){
    ...
    // gfx
    DGFXBase::Config dgfxbase_config;
    dgfxbase_config.sample_rate = settings.sampleRate;
    dgfxbase_config.channels = dmix_config.channels;
    dgfxbase_config.child = &dmixer;
    dgfxbase.Init(dgfxbase_config);
